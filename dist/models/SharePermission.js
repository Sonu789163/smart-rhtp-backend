...
sharePermissionSchema.index({ domain: 1, resourceType: 1, resourceId: 1, scope: 1, principalId: 1 }, { unique: true, sparse: true });
// Unique index for link-scoped shares (linkToken must be unique per scope)
sharePermissionSchema.index({ scope: 1, linkToken: 1 }, { unique: true, sparse: true, partialFilterExpression: { scope: "link", linkToken: { $exists: true } } });
