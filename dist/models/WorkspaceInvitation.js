...
const workspaceInvitationSchema = new mongoose_1.default.Schema({
    // Invitation details
...
workspaceInvitationSchema.statics.generateInvitationId = function () {
...
workspaceInvitationSchema.methods.canBeAccepted = function () {
    return this.status === "pending" && !this.isExpired();
};
exports.WorkspaceInvitation = mongoose_1.default.model("WorkspaceInvitation", workspaceInvitationSchema);
