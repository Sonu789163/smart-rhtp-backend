...
const domainSchema = new mongoose_1.default.Schema({
    ...
    matched_investors: { type: mongoose_1.default.Schema.Types.Mixed, default: [] }, // Pipeline output: matched investor results
    ...
    subquery_analysis: { type: mongoose_1.default.Schema.Types.Mixed, default: {} },
